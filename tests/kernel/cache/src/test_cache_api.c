...
__dcacheline_exclusive_data static uint8_t var_exclusive_data1 = 9;
__dcacheline_exclusive_data static uint8_t var_exclusive_data2[5] = {4};
__dcacheline_exclusive_data static uint8_t var_exclusive_data3[3] = {7};
