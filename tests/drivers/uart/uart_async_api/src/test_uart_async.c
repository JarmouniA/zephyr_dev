...
#if NOCACHE_MEM
static struct test_data tdata __nocache;
#else
...
#if NOCACHE_MEM
static __aligned(32) uint8_t chained_read_buf[2][8] __nocache;
static __aligned(32) uint8_t chained_cpy_buf[10] __nocache;
#else
...
#if NOCACHE_MEM
static __aligned(32) uint8_t double_buffer[2][12] __nocache;
#else
...
#if NOCACHE_MEM
static __aligned(32) uint8_t test_read_abort_rx_buf[2][100] __nocache;
static __aligned(32) uint8_t test_read_abort_read_buf[100] __nocache;
#else
...
#if NOCACHE_MEM
static __aligned(32) uint8_t test_rx_buf[2][100] __nocache;
#else
...
{
#if NOCACHE_MEM
	static __aligned(32) uint8_t rx_buf[20] __nocache;
#else
	uint8_t rx_buf[20];
#endif /* NOCACHE_MEM */
...
#if NOCACHE_MEM
static __aligned(32) uint8_t long_rx_buf[1024] __nocache;
static __aligned(32) uint8_t long_rx_buf2[1024] __nocache;
static __aligned(32) uint8_t long_tx_buf[1000] __nocache;
#else
